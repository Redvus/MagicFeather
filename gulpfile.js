...
let path = {
    ...
    dest: {
        css: '_build/assets/games/magicFeather/css',
        js: '_build/assets/games/magicFeather/js/'
    },
    watch: {
        scss: '_develop/scss/',
        js: '_develop/_js/'
...
gulp.task('app-js', function(){
    return gulp.src([
        ...
        path.src.js + 'questCat_3.js',
        path.src.js + 'questCat_4.js',
        path.src.js + 'questCat_5.js',
        path.src.js + 'app.js'
    ])
        .pipe(concat('app.js'))
        .pipe(terser())
...
gulp.task('watch', function() {
    ...
    gulp.watch([path.watch.js + 'app.js',
        ...
        path.watch.js + 'questCat_3.js',
        path.watch.js + 'questCat_4.js',
        path.watch.js + 'questCat_5.js'
    ], gulp.series('app-js'));
